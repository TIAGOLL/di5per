            ...
            <form method="POST" action="{{ route('auth') }}" class="w-[20rem] h-[1rem]">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex items-center justify-center">
                        ...
                        <input type="email" name="email" id="email" class="mt-1 block w-full h-8 border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-2 shadow-md" required autofocus>
                    </div>
                </div>
                <div class="mb-4">
                    ...
                    <div class="flex items-center justify-center">
                        ...
                        <input type="password" name="password" id="password" class="h-8 mt-1 block w-full border-2 border-gray-300 rounded-md shadow-md focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm " required>
                    </div>
                </div>
                <div class="w-full items-center justify-center flex">
                    <button type="submit" class="w-[13rem] py-2 px-4 border border-transparent rounded-3xl shadow-md text-sm font-medium text-white bg-[#3E3A4E] hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 justify-center items-center">Entrar</button>
                </div>
